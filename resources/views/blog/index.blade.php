            ...
            <div class="resume-inner">
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="dashbord-sidebar">
                            <ul>
                                ...
                                <li><a class="active" href="{{ route('blog.index') }}"><i class="lni lni-bookmark"></i> Gestion des blogs</a></li>
                    ...
                    <div class="col-lg-8 col-12">
                        <div>
                            <h4 class="mt-4 float-left ml-4">Liste des Blogs</h4>
                            <button type="submit" class="btn btn-success mt-4 float-right mr-4">
                                <a href="{{ route('blog.create') }}" style="color:white">AJOUTER</a>
                            </button>
                        </div>
                               ...
                               @foreach ($blogs as $blog)
                                    <div class="single-exp mb-30">
                                        <div class="d-flex align-items-center pr-11 mb-9 flex-wrap flex-sm-nowrap">
                                            <div class="image">
                                                 <img src="{{ Storage::url($blog->image->path) }}" alt="#" width="100px" height="100px">
                                            </div>
                                            <div class="w-100 mt-n2">
                                                <h5 class="mb-0">{{ $blog-> title }}</h5>
                                                <p class="mb-0">{{ $blog->categorie->title }}</p>
                                                <div class="d-flex align-items-center justify-content-md-between flex-wrap">
                                                    <a>{{ $blog->categorie->title }}</a>
                                                    <div>
